...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_expired->setUpdatedAt(new \DateTime());
        ...
        $job_extreme_sensio->setUpdatedAt(new \DateTime());
        ...
        for ($i = 100; $i <= 130; $i++) {
            ...
            $job->setLogo('http://symfony.com/images/common/logo/logo_symfony_header.png');
            $job->setUrl('http://www.google.pl');
            $job->setPosition('Web Developer');
            ...
            /* $job->setExpiresAt(new \DateTime('2013--10')); */
